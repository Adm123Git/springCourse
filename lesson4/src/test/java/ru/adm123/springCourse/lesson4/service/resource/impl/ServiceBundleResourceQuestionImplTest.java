...
class ServiceBundleResourceQuestionImplTest {
    ...
    private ServiceBundleResource serviceBundleResourceQuestionImpl;
    private final MessageSource messageSource = Mockito.mock(MessageSource.class);

    @BeforeEach
    public void init() {
        serviceBundleResourceQuestionImpl = new ServiceBundleResourceQuestionImpl(messageSource);
        Mockito
    ...
    public void getString_throwsRTE_ifMessageSourceIsNull() {
        Assertions
                .assertThatThrownBy(() -> new ServiceBundleResourceQuestionImpl(null).getString(KEY_WHICH_EXISTS))
    ...
    public void getString_returnsNull_ifMessageIsNotFound() {
        Assertions
                .assertThat(serviceBundleResourceQuestionImpl.getString(KEY_WHICH_NOT_EXISTS))
                .isNull();
    }
    ...
    public void getString_returnsDefMessage_ifMessageIsFound() {
        Assertions
                .assertThat(serviceBundleResourceQuestionImpl.getString(KEY_WHICH_EXISTS))
