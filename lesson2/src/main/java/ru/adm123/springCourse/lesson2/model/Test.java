package ru.adm123.springCourse.lesson2.model;
...
public class Test implements Printable {
    ...
    public void print(OutputStream stream) throws IOException {
        String result = "Student " + studentName +
                " get " + getRightAnswerCount() + " right answers" +
                " from " + getQuestionCount() + " questions.\n" +
                "Test completed as " + (isTestCompetedSuccess() ? "OK" : "FAIL");
